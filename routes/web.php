...
Route::get('/offers/{id}', \App\Livewire\Website\Offers\OfferDetail::class)->name('offers.details');
Route::get('/blogs',\App\Livewire\Website\Blogs\Blogs::class)->name('blogs');
Route::get('/blogs/{id}',\App\Livewire\Website\Blogs\BlogDetails::class)->name('blogs.details');
